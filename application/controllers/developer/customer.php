...
class Customer extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('developer/customer_model');
    }

    public function index() {
        redirect('developer/customer/view');
    }

    public function view() {

        //Pagination
        $config['base_url'] = base_url('developer/customer/view/');
        ...
        // Template
        $this->template->developer('customers', $data);
    }

    function detail($id) {
        if ($id == NULL) {
            redirect('developer/customer/');
        }
        $data['title'] = 'Customer Detail';
        $data['customer'] = $this->customer_model->detail($id);
        $this->template->developer('customer_detail', $data);
    }

    public function export() {
        //$this->load->view('developer/customer_report');
        //$data['title'] = 'Export';
        //$this->template->developer('export_customers', $data);

        $this->load->helper('dompdf');
        $this->load->helper('file');
        // page info here, db calls, etc.
        $html = $this->load->view('developer/customer_report', $data = NULL, true);
