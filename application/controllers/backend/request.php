...
class Request extends CI_Controller {
    ...
    public function index() {
        redirect('dashboard/request/view');
    }
    ...
    public function view() {
       ...
       $config['per_page'] = 5;
        ...
        //Template
        $this->template->backend('requests', $data);
    }
    ...
    function detail($id) {
        ...
        $this->template->backend('request_detail', $data);
    }
    ...
    public function approval($id) {
        ...
        if (!$this->input->post()) {
            ...
            $this->theme_model->edit($this->input->post('theme_id'),array('theme_status'=>1));
            redirect('dashboard/request/');
        }
    }
    ...
    public function rejected() {
       ...
       $config['per_page'] = 5;
        ...
        //Title
        $data['title'] = 'View Rejected Requests';
