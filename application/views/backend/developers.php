        ...
        <?php foreach ($users->result() as $value) : ?>
            <tr>
                ...
                <td>
                    ...
                    <div class="btn-group">
                        <a class="btn btn-small" href="<?php echo base_url('dashboard/developer/edit/' . $value->developer_id); ?>"><i class="icon-pencil"></i> Edit</a>
                        <a class="btn btn-small" href="<?php echo base_url('dashboard/developer/del/' . $value->developer_id); ?>"><i class="icon-remove"></i> Delete</a>
                    </div>
                </td>
            </tr>
        <?php endforeach; ?>
