...
<html lang="en">
    ...
    <body>
<center><h1>Account Manager</h1></center>
        <div class="container">
            <form class="form-signin" name="login" action="<?php echo base_url('auth/login'); ?>" method="POST">
                <div class="row-fluid">
                ...
                <br />
                Please <a href="<?php echo base_url('register'); ?>">register</a> if you don't have an account
                </div>
            </form>
